...
[mTLS](/docs/{{ page.version }}/policies/mutual-tls) is required to enable `ZoneEgress`. After configuration change you should be able to communicate with services in other zone or external services through `ZoneEgress`.
